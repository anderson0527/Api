...
using todoanderson.Common.Responses;
using todoanderson.Functions.Entities;

namespace todoanderson.Functions.Functions{
    public static class TodoApi{
        [FunctionName(nameof(CreateTodo))]
        public static async Task<IActionResult> CreateTodo(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "todo")] HttpRequest req,
            [Table("todo", Connection = "AzureWebJobsStorage")] CloudTable todoTable, ILogger log){
            ...
            string message = "New todo estorage in table";
        ...
        public static IActionResult GetTodoById(
            ...
            [Table("todo", "TODO", "{id}", Connection = "AzureWebJobsStorage")] TodoEntity todoEntity, string id, ILogger log){
